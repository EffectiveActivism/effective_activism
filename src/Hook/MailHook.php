  ...
  public function invoke(array $args) {
    ...
    switch ($key) {
      ...
      case Constant::MAIL_KEY_INVITATION_MANAGER:
        ...
        $message['body'][] = 'Hello';
        $message['body'][] = sprintf('You have been invited to join %s as manager on http://www.activeforanimals.com.', $params['organization_label']);
        $message['body'][] = 'To join, follow these steps:';
        $message['body'][] = '- Create an account at http://www.activeforanimals.com/user using the e-mail address that this e-mail was sent to.';
      ...
      case Constant::MAIL_KEY_INVITATION_ORGANIZER:
        ...
        $message['body'][] = 'Hello';
        $message['body'][] = sprintf('You have been invited to join the group \'%s\' of the organizaiton %s as organizer on http://www.activeforanimals.com.', $params['group_label'], $params['organization_label']);
        $message['body'][] = 'To join, follow these steps:';
        $message['body'][] = '- Create an account at http://www.activeforanimals.com/user using the e-mail address that this e-mail was sent to.';
