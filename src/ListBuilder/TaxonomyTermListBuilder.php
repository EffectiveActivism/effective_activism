...
/**
 * Defines a class to build a listing of taxonomy term entities.
 *
 * @ingroup effective_activism
 */
class TaxonomyTermListBuilder extends EntityListBuilder {
  ...
  protected function getEntityIds() {
    ...
    $query
      ->condition('vid', sprintf('tags_%d', $this->organization->id()))
      ->sort('name');
  ...
  public function render() {
    ...
    $build['#storage']['entities']['taxonomy_terms'] = $this->load();
    $build['#cache'] = [
