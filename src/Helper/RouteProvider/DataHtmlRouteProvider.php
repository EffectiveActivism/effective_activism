...
class DataHtmlRouteProvider extends DefaultHtmlRouteProvider {
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\effective_activism\Controller\DataAddController::addForm',
          '_title_callback' => 'Drupal\effective_activism\Controller\DataAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\effective_activism\Controller\DataAddController::add',
