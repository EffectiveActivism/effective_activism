...
class EventTemplateHtmlRouteProvider extends DefaultHtmlRouteProvider {
    ...
    if ($entity_type->hasLinkTemplate('version-history')) {
      ...
      $route
        ->setDefaults([
          ...
          '_controller' => '\Drupal\effective_activism\Controller\EventTemplateController::revisionOverview',
        ])
        ->setRequirement('_permission', 'access event_template revisions')
  ...
  protected function getRevisionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision')) {
      ...
      $route
        ->setDefaults([
          '_controller' => '\Drupal\effective_activism\Controller\EventTemplateController::revisionShow',
          '_title_callback' => '\Drupal\effective_activism\Controller\EventTemplateController::revisionPageTitle',
        ])
        ->setRequirement('_permission', 'access event_template revisions')
        ->setOption('_admin_route', TRUE);
      return $route;
  ...
  protected function getRevisionRevertRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('revision_revert')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\effective_activism\Form\EventTemplateRevisionRevertForm',
          '_title' => 'Revert to earlier revision',
        ])
        ->setRequirement('_permission', 'revert all event_template revisions')
        ->setOption('_admin_route', TRUE);
      return $route;
    }
  }
  ...
  protected function getPublishFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('publish-form')) {
      ...
      $route
        ->setDefaults([
          '_form' => '\Drupal\effective_activism\Form\EventTemplate\EventTemplatePublishForm',
